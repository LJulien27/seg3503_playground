...
public class DateExceptionTest {
	...
	public static List<Integer[]> data(){
		...
		//code nouveau pour tests
		params.add(new Integer[] {2023, 03, 32, 0,0,0});
		params.add(new Integer[] {2023, 02, 30, 0,0,0});
		params.add(new Integer[] {2023, 04, 31, 0,0,0});
		params.add(new Integer[] {2023, 00, 32, 0,0,0});
		return params;
	}
